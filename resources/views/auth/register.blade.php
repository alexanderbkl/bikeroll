                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="is_pro"
                                    class="col-md-4 col-form-label text-md-end">{{ __('PRO') }}</label>
                                <div class="col-md-6">
                                    <input type="hidden" name="is_pro" value="0">

                                    <input id="is_pro" type="checkbox"
                                        class="checkbox @error('is_pro') is-invalid @enderror" name="is_pro"
                                        value="{{ old('is_pro', "1") }}" autocomplete="is_pro" autofocus>
                                    @error('is_pro')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
